...
/* 
Black box
Восстанови логику метода someAction для поля solutionAction.
        ...
        public void someAction() {
          ...
          //  super.someAction();
            ...
            SecondClass secondClass = new SecondClass(){
                ...
                public void someAction() {
                    super.someAction();
                    System.out.println(SecondClass.SPECIFIC_ACTION_FOR_ANONYMOUS_SECOND_CLASS_PARAM.substring(1,
                            SecondClass.SPECIFIC_ACTION_FOR_ANONYMOUS_SECOND_CLASS_PARAM.length())+param);
                }
            };

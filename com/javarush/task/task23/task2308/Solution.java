...
4. В классе Constants должна существовать константа SERVER_IS_NOT_CURRENTLY_ACCESSIBLE со значением "The server is not currently accessible.".
...
public class Solution {
    ...
    public final class Constants {
        ...
        public static final String ACCESS_IS_DENIED = "The access is denied.";
    }
